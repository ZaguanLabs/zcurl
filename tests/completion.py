...
def test(env, plain, temp):
    ...
    try:
        ...
        complete('zcurl po', 'zcurl poll ')
        complete('zcurl poll --ti', 'zcurl poll --timeout ')
        complete('zcurl poll --max-c', 'zcurl poll --max-chunk ')
        complete('zcurl poll -r zc_hash_v', 'zcurl poll -r zc_hash_valid ')
        complete('zcurl poll --timeout 100 --ti', 'zcurl poll --timeout 100 --ti')
        complete('zcurl poll --da', 'zcurl poll --da')
        ...
        complete('zcurl headers --na', 'zcurl headers --names ')
        complete('zcurl headers --names --fr', 'zcurl headers --names --from ')
        complete('zcurl headers --names --tra', 'zcurl headers --names --trailers ')
        complete('zcurl headers --names -r zc_array_v', 'zcurl headers --names -r zc_array_valid ')
        complete('zcurl headers --names -r zc_hash_v', 'zcurl headers --names -r zc_hash_v')
        complete('zcurl headers --names --na', 'zcurl headers --names --na')
        complete('zcurl headers --fi', 'zcurl headers --field ')
        complete('zcurl headers --field Set-C', 'zcurl headers --field Set-Cookie ')
        complete('zcurl headers --field ETag --fr', 'zcurl headers --field ETag --from ')
        complete('zcurl headers --field --names -r zc_array_v', 'zcurl headers --field --names -r zc_array_valid ')
