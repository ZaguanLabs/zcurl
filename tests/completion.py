...
def test(env, plain, temp):
    ...
    try:
        ...
        complete('zcurl -x http://example.invalid --pro', 'zcurl -x http://example.invalid --pro')
        ...
        complete('zcurl ws open channel -x http://example.invalid --pro', 'zcurl ws open channel -x http://example.invalid --pro')
