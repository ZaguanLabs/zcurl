...
def test(env, plain, temp):
    ...
    try:
        ...
        complete('zcurl session configure session_live --pro', 'zcurl session configure session_live --proxy-cacert ')
        ...
        complete('zcurl session configure session_live --proxy-cacert file --pro', 'zcurl session configure session_live --proxy-cacert file --pro')
