# Native Zsh completion (0.12.0-dev)
...
- HTTP proxy/bypass options and proxy URL scheme prefixes. Bypass lists remain
  literal input; completion does not discover proxies or look up hosts.
